...
const JOBS = [
  ...
  { file: 'banners/hero.png', prompt: `Editorial lifestyle photograph: a graphic designer at a clean white wooden desk arranging crisp blank-white business cards in a fan, with a folded blank-white brochure and a rolled blank poster nearby. A small green plant in the corner. Soft warm window light from the left, shallow depth of field. Subtle indigo accents on the brochure. NO TEXT, NO LETTERS, NO LOGOS, NO WRITING anywhere — every printed item is a plain blank coloured paper sample. Square 1:1 aspect ratio. Hyper-realistic, magazine-quality.` },
